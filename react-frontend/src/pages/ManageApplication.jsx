                ...
                {currentListing.position}
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 flex gap-6">
                        ...
                        <div className="flex-1">
                            ...
                            <h2 className="text-xl font-bold text-gray-900">{currentListing.position}</h2>
                            ...
                            <div className="text-sm mt-3 text-gray-700 space-y-2">
                                {showMore ? (
                                    <>
                                        <p><strong>Company:</strong> {currentListing.companyName}</p>
                                        <p><strong>Location:</strong> {currentListing.location}</p>
                                        <p><strong>Type:</strong> {currentListing.workType}</p>
                                        <p><strong>Condition:</strong> {currentListing.workCondition}</p>
                                        <p><strong>Experience:</strong> {currentListing.experience}</p>
                                        <p><strong>Salary:</strong> {currentListing.salary}</p>
                            ...
                            <div className="flex justify-between items-center mt-4">
                                <div>
                                    <div className="text-2xl font-semibold text-gray-900">{applicantListing.length}</div>
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6 mt-8 overflow-x-auto">
                        <h2 className="text-xl font-semibold mb-4">{"Applicant(" + applicantListing.length + ")"}</h2>
                        ...
                        {applicantListing.map((applicant) => (
                            ...
                            >
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    />
                                    <div className="text-gray-800 font-medium">{applicant.userFirstName+" "+applicant.userLastName}</div>
                                </div>
                                ...
                                {editingTarget === applicant.userID ?(
                                    ...
                                    <div className="text-orange-500 font-medium">{applicant.score}</div>
                                )}
                                ...
                                <div>{editingTarget === applicant.userID ?
                                    (
                                        <select className="px-4 py-2 border rounded text-gray-700 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                        ...
                                        <div className="text-orange-500 font-medium">{applicant.status}</div>
                                    )}
                                </div>
