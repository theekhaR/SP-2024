...
function Listing() {
  ...
  const handleApplyListing = async (selectlistingID, selectuserID) => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/add_user_applicantion`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
      <div className="bg-gray-100 flex flex-col">
        ...
        <div className="flex h-screen">
          {/* Left - Job List */}
          <div
              className="w-1/5  overflow-y-auto border border-gray-300 bg-white shadow-md rounded-lg overflow-y-scroll scrollbar-hide ">
          ...
          {/* Middle - Job Details */}
          <div
              className="w-3/5 p-4 bg-white border border-gray-300 shadow-md rounded-lg overflow-y-scroll scrollbar-hide">
            {selectedJob && (
                <div>
            ...
            {selectedJob && (
                <div className="max-w-xs mx-auto pr-4 pl-4">
                  ...
                  <div className="mt-6 space-y-3">
                    ...
                    onClick={() => handleApplyListing(selectedJob.listingID, userID)}>
                      Apply For Position
                    </button>
